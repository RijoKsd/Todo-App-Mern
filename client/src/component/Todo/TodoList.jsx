...
const TodoList = () => {
  const { todos, completedTodos, getAllTodos, pendingTodos,token } =
...
const [completedStatus, setCompletedStatus] = useState({});
  ...
  try{
    await axios.put(`http://localhost:5000/api/todo/update/${id}`,{
      completed: true
    },{
      headers:{
               ...
               <div className="d-flex justify-content-between align-items-center">
                 <p className="text-muted" style={{
                  fontSize:"12px"
                   ...
                   {new Date(completedTodo.completedAt).toDateString() + " " + new Date(completedTodo.completedAt).toLocaleTimeString()}
                 </p>
                 <div className="d-flex gap-3">
                   <FaTrashAlt
                     className="text-danger"
